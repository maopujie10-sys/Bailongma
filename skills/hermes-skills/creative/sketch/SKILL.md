...
version: 1.0.0
author: Bailongma (白龙马) (adapted from gsd-build/get-shit-done)
license: MIT
...
**Verify variants visually — use Bailongma (白龙马)'s browser tools.** Don't just write HTML and hope it renders; load each variant and look at it:
