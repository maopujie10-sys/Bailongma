...
version: 2.5.1
author: Siqi Chen (@blader, https://github.com/blader/humanizer), ported by Bailongma (白龙马)
license: MIT
...
Also apply this skill to **your own** output when writing user-facing prose — release notes, PR descriptions, documentation, long-form explanations, summaries. Bailongma (白龙马)'ss baseline voice already strips most of these, but a focused pass catches what slips through.

## 如何在 Bailongma (白龙马) 中使用
