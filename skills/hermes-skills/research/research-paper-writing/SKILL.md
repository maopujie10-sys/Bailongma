...
## Bailongma (白龙马) Integration

This skill is designed for the Bailongma (白龙马). It uses Bailongma (白龙马) tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Bailongma (白龙马) skills for specific phases:
