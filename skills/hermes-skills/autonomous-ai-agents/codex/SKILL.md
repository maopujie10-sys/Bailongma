...
version: 1.0.0
author: Bailongma (白龙马)
license: MIT
platforms: [linux, macos, windows]
tags: [Coding-Agent, Codex, OpenAI, Code-Review, Refactoring]
related_skills: [claude-code, bailongma]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via Bailongma (白龙马) terminal. Codex is OpenAI's autonomous coding agent CLI.
...
For Bailongma (白龙马) itself, `model.provider: openai-codex` uses Bailongma (白龙马)-managed Codex
OAuth from `$BAILONGMA_USER_DIR/auth.json` after `hermes auth add openai-codex`. For the
...
## Bailongma (白龙马) 网关注意事项

When invoking the Codex CLI from a Bailongma gateway/service context (for example,
