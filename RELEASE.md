...
- `D:\Projects\AI项目\BaiLongma-main\dist-build\Bailongma-Setup-2.4.5.exe`
- `D:\Projects\AI项目\BaiLongma-main\dist-build\latest.yml`

## Local Verification Checklist

1. Install `Bailongma-Setup-2.4.5.exe`.
...
- GitHub Release asset: `Bailongma-Setup-2.4.5.exe`
- GitHub Release asset: `latest.yml`
- GitHub Release asset: `Bailongma-Setup-2.4.5.exe.blockmap`
