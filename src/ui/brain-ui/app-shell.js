      ...
      <div class="settings-content">
        ...
        <div class="settings-tab" data-tab="voice">
          ...
          <div class="settings-section" id="settings-tts-section">
            ...
            <p class="settings-hint">用语音发消息时，Agent 回复会自动转为语音播放。支持 Edge TTS（免费）/ 阿里云（免费额度）/ 腾讯云（免费额度）/ 豆包 / MiniMax / OpenAI / ElevenLabs / 火山引擎。需先 pip install edge-tts。</p>
            <div class="settings-row">
            ...
            <div class="settings-row">
              ...
              <select class="settings-select" id="tts-provider-select">
                <option value="edgetts">🔥 Edge TTS（微软，完全免费，需Python edge-tts）</option>
                <option value="aliyun">阿里云智能语音（每月100万字免费）</option>
                <option value="tencent">腾讯云语音合成（每月100万字免费）</option>
            ...
            <div id="tts-creds-edgetts" style="display:none;">
              <p class="settings-hint" style="color:#4caf50;font-weight:bold;">✅ Edge TTS 完全免费，需先安装: pip install edge-tts</p>
              <p class="settings-hint">使用微软 Edge 浏览器的「大声朗读」同款神经语音引擎。支持 20+ 中文声音（含粤语、台湾腔、东北话、四川话）。</p>
              <div class="tts-fx-srow" style="margin-bottom:8px;">
                <label for="tts-edgetts-rate">语速</label>
                <input type="range" id="tts-edgetts-rate" min="-50" max="100" step="5" value="0">
                <span id="tts-edgetts-rate-val">0%</span>
              </div>
              <div class="tts-fx-srow" style="margin-bottom:8px;">
                <label for="tts-edgetts-pitch">音调</label>
            ...
            <div id="tts-creds-aliyun" style="display:none;">
              <p class="settings-hint" style="color:#4caf50;font-weight:bold;">🔑 自动复用语音识别（ASR）的 DashScope 密钥</p>
              <p class="settings-hint">如果未填写下方密钥，会自动使用「语音对话」中已配置的阿里云 DashScope API Key。</p>
              <div class="settings-row">
                <label class="settings-label" for="tts-aliyun-appkey">DashScope API Key（选填）</label>
                <input class="settings-input" type="password" id="tts-aliyun-appkey" placeholder="留空则自动复用ASR密钥（sk-开头）">
              </div>
              <p class="settings-hint">使用百炼 qwen3-tts-flash / qwen-tts 模型。支持 Cherry、Stella、Jace 等音色。在<a href="https://dashscope.console.aliyun.com/" target="_blank" style="color:var(--cool)">百炼控制台</a>获取密钥。</p>
            </div>
            <!-- 腾讯云 creds -->
            <div id="tts-creds-tencent" style="display:none;">
              <div class="settings-row">
                <label class="settings-label" for="tts-tencent-appid">AppId</label>
                <input class="settings-input" type="text" id="tts-tencent-appid" placeholder="腾讯云 AppId">
              </div>
              <div class="settings-row">
                <label class="settings-label" for="tts-tencent-secret-id">SecretId</label>
                <input class="settings-input" type="text" id="tts-tencent-secret-id" placeholder="腾讯云 API 密钥 SecretId">
              </div>
              <div class="settings-row">
                <label class="settings-label" for="tts-tencent-secret-key">SecretKey</label>
                <input class="settings-input" type="password" id="tts-tencent-secret-key" placeholder="腾讯云 API 密钥 SecretKey">
              </div>
              <p class="settings-hint">在<a href="https://console.cloud.tencent.com/cam/capi" target="_blank" style="color:var(--cool)">腾讯云 API 密钥管理</a>获取。每月 100 万字符免费。</p>
            </div>
