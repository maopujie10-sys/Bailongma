...
// DefaultContextEngine wraps existing gatherContext logic, registered in engine-registry
...
// Auto-register the default engine
registerEngine('default', new DefaultContextEngine())
